  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col gap-4 px-4 py-6">
      ...
      <div className="flex flex-col gap-4 text-sm leading-relaxed">
        <section>
          <h2 className="mb-1 font-semibold text-foreground">1. Who we are</h2>
        ...
        <section>
          <h2 className="mb-1 font-semibold text-foreground">2. Acceptance</h2>
          <p className="text-muted">By creating an account or using Racked, you agree to these terms.</p>
        </section>

        <section>
          <h2 className="mb-1 font-semibold text-foreground">3. The service</h2>
          <p className="text-muted">
        ...
        <section>
          <h2 className="mb-1 font-semibold text-foreground">4. Accounts</h2>
          <p className="text-muted">
        ...
        <section>
          <h2 className="mb-1 font-semibold text-foreground">5. User content &amp; conduct</h2>
        ...
        <section>
          <h2 className="mb-1 font-semibold text-foreground">6. Premium subscription</h2>
          <ul className="list-disc pl-5 text-muted">
            ...
            <li>
              Payments are non-refundable except where required by law. If you&rsquo;re charged in error (e.g. a
              billing glitch or a cancellation that didn&rsquo;t take effect), contact us at [add your contact
              email here] and we&rsquo;ll review it. Purchases made through the Apple App Store or Google Play are
              refunded by Apple/Google under their own policies, not by us directly.
            </li>
          </ul>
        </section>

        <section>
          <h2 className="mb-1 font-semibold text-foreground">7. Disclaimers</h2>
          <p className="text-muted">
        ...
        <section>
          <h2 className="mb-1 font-semibold text-foreground">8. Limitation of liability</h2>
          <p className="text-muted">
        ...
        <section>
          <h2 className="mb-1 font-semibold text-foreground">9. Termination</h2>
          <p className="text-muted">
        ...
        <section>
          <h2 className="mb-1 font-semibold text-foreground">10. Changes</h2>
          <p className="text-muted">
        ...
        <section>
          <h2 className="mb-1 font-semibold text-foreground">11. Governing law</h2>
